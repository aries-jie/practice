package com.aries.spring.condition;
...
public class ConditionDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 获取指定模式下的所有资源
        Resource[] resources = resolver.getResources("classpath*:com/aries/spring/bean/**/*.class");

        // 创建自定义条件类的实例，用于条件匹配
        Condition condition = new MyOnClassCondition("com.aries.spring.condition.ConditionDemo");
